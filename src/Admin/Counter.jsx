...
const AdminDash = () => {
  ...
  const [visibleItemsCount, setVisibleItemsCount] = useState(10); // State to manage visible items
  ...
  const handleShowMore = () => {
    setVisibleItemsCount(userData.length); // Show all items
  };

  const handleShowLess = () => {
    setVisibleItemsCount(10); // Show only the initial 10 items
  };
            ...
            {userData.length === 0 ? (
              ...
              <>
                <Table aria-label="Example static collection table" removeWrapper>
                  ...
                  <TableBody>
                    {userData.slice(0, visibleItemsCount).map((user, index) => (
                ...
                <div className="flex justify-end mt-2">
                  {visibleItemsCount < userData.length ? (
                    <a
                      href="#"
